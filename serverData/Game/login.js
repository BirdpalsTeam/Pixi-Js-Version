													...
													if(result !== null){
														...
														if(players.size > 0){	//Check if there is at least one player online
															...
															if(playerAlreadyLogged != false){
																...
																let thisPlayerRoom = rooms[playerAlreadyLogged.gameRoom];
																let preventRecursion2 = thisPlayerRoom.players;
																let thisPlayer = preventRecursion2.get(playerAlreadyLogged.playerId);
									...
									function createPlayer(thisPlayer, inventory, biography){
										PlayFabServer.GetFriendsList({PlayFabId: PlayFabId}, (error, result)=>{
											if(error !== null){
												...
												rooms.town.players.set(thisPlayer.id, thisPlayer);
